...
const QUOTES = [
  {
    ...
    rotate: "-rotate-6",
    position: "left-[4%] top-[12%] md:left-[8%] md:top-[18%]",
    hideOnMobile: false,
  },
  {
    ...
    rotate: "rotate-3",
    position: "right-[6%] top-[22%] md:right-[12%] md:top-[20%]",
    hideOnMobile: true,
  },
  {
    ...
    author: "Your wallet",
    rotate: "-rotate-2",
    position: "left-[10%] bottom-[28%] md:left-[14%] md:bottom-[32%]",
    hideOnMobile: false,
  },
  {
    ...
    author: "Tab hoarder",
    rotate: "rotate-6",
    position: "right-[8%] bottom-[22%] md:right-[10%] md:bottom-[28%]",
    hideOnMobile: true,
  },
];
