...
export const SELLING_POINTS = [
  {
    ...
    icon: Bookmark,
    accent: "from-amber-100 to-orange-50 dark:from-amber-950/40 dark:to-orange-950/30",
    tilt: "-rotate-2",
    Demo: AnyStoreStatic,
  },
  {
    ...
    icon: LayoutGrid,
    accent: "from-yellow-50 to-amber-100 dark:from-yellow-950/30 dark:to-amber-950/40",
    tilt: "rotate-1",
    Demo: OnePlaceStatic,
  },
  {
    ...
    icon: Heart,
    accent: "from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30",
    tilt: "rotate-2",
